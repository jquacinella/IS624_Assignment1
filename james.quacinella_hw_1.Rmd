...
The following code produces two graphs of the pre and post transformation of the monthly total of accidental deaths in the United States. TODO
...
The following code produces two graphs of the pre and post transformation of the Quarterly production of bricks. TODO
...
To become familiar with the ibmclose data set, here we plot the time series with some running averages. The big dip in price is going to give us trouble with our simplistic forcasting.
